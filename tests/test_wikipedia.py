...
def test_iter_paginates_across_continue():
    page1 = {
        'query': {'usercontribs': [_uc(10, 9, '2026-06-10T00:00:00Z'), _uc(9, 8, '2026-06-09T00:00:00Z')]},
...
def test_iter_stops_at_cutoff():
    page = {'query': {'usercontribs': [_uc(10, 9, '2026-06-10T00:00:00Z'), _uc(9, 8, '2026-06-01T00:00:00Z')]}}
...
def test_fetch_diff_new_page():
    diff = _wiki([FakeResp({'parse': {'wikitext': '== Heading =='}})]).fetch_diff(make_edit(parentid=0, is_new=True))
